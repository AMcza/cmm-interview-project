...
public class QuestionBankQuestionController {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> batchDeleteQuestionBankQuestion(@RequestBody QuestionBankQuestionBatchRemoveRequest questionBankQuestionBatchRemoveRequest){
        ThrowUtils.throwIf(questionBankQuestionBatchRemoveRequest==null,ErrorCode.PARAMS_ERROR);
        questionService.batchDeleteQuestions(questionBankQuestionBatchRemoveRequest.getQuestionIdList());
        return ResultUtils.success(true);
    }
}
