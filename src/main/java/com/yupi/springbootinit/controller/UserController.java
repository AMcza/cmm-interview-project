...
public class UserController {
    ...
    public BaseResponse<Map<LocalDate,Boolean>> getUserSignInRecord(HttpServletRequest request,Integer year){
        //必须要登录才签到
        User loginUser=userService.getLoginUser(request);
    ...
    public BaseResponse<List<Integer>> getUserSignInRecord2(HttpServletRequest request,Integer year){
        //必须要登录才签到
        User loginUser=userService.getLoginUser(request);
        List<Integer> userSignInRecord2 = userService.getUserSignInRecord2(loginUser.getId(), year);
        return ResultUtils.success(userSignInRecord2);
    }
}
